...
//import MediaPlayer
//
//class s: UITableViewController, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate, UISearchControllerDelegate, UISearchBarDelegate, UISearchResultsUpdating, UINavigationControllerDelegate, NSFileManagerDelegate  {
//    
//    // MARK: - var and lets
...
//        
//        var pa = fm.contentsAtPath(objectForPass)!
//        
//        var fileURL = NSURL(fileURLWithPath: objectForPass)!
//        println("File while segue \(fileURL)")
//        if segue.identifier == "listenMusic" {
//            //playerVC.object = objectForPass
//            //playerVC.urlForFile = fileURL
//        }
//    }
//
//}
